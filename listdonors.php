        ...
        <table class="w-full rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
            ...
            <div class="flex items-start justify-center mb-12">
                <div class="text-center">
                    <h5 class="font-bold text-4xl">DONORS LIST</h5>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "
                            <tr class='bg-gray-100 border-b border-gray-200'>
                                <td class='px-4 py-3'>$donor_id</td>
                                <td class='px-4 py-3'>$donor_name</td>
                                <td class='px-4 py-3'>$donor_lastname</td>
                                <td class='px-4 py-3'>$donor_mail</td>
                                <td class='px-4 py-3'>$donor_birthdate</td>                                
                                <td class='px-4 py-3'>$donor_address</td>
                                <td class='px-4 py-3 text-blue-500'><a href='listmembers.php'>$member_id</a></td>
