    ...
    <div class="mt-10 mx-4 min-h-screen overflow-x-auto">
        <table class="w-full rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
            <tr class="text-left border-b-2 border-gray-300">
                ...
                <th class="px-4 py-3">People Number in Household</th>
                <th class="px-4 py-3">Children Number</th>
                <th class="px-4 py-3">Child Educational Status</th>
                <th class="px-4 py-3">Employment</th>
                <th class="px-4 py-3">Expenditures</th>
                <th class="px-4 py-3">Needed Support</th>
            ...
            <div class="flex items-start justify-center mb-12">
                <div class="text-center">
                    <h5 class="font-bold text-4xl">REQUESTS LIST</h5>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $indigent_people_number = $row['indigent_people_number'];
                $indigent_children_number = $row['indigent_children_number'];
                $indigent_child_educational_status = $row['indigent_child_educational_status'];
                $indigent_employment = $row['indigent_employment'];
                $indigent_expenditures = $row['indigent_expenditures'];
                $indigent_needed_support = $row['indigent_needed_support'];
                ...
                echo "
                            <tr class='bg-gray-100 border-b border-gray-200'>
                                <td class='px-4 py-3'>$indigent_id</td>
                                <td class='px-4 py-3'>$indigent_name</td>
                                <td class='px-4 py-3'>$indigent_lastname</td>
                                <td class='px-4 py-3'>$indigent_phone</td>
                                <td class='px-4 py-3'>$indigent_address</td>
                                <td class='px-4 py-3'>$indigent_income</td>
                                <td class='px-4 py-3'>$indigent_people_number</td>
                                <td class='px-4 py-3'>$indigent_children_number</td>
                                <td class='px-4 py-3'>$indigent_child_educational_status</td>
                                <td class='px-4 py-3'>$indigent_employment</td>
                                <td class='px-4 py-3'>$indigent_expenditures</td>
                                <td class='px-4 py-3'>$indigent_needed_support</td>
